...
export default function HomePage() {
  ...
  const featuredGuides = [
    { title: 'Best VPNs for Remote Workers 2026', image: '/images/categories/cat-best-vpns.webp', url: '/guides/best-vpns-for-remote-workers-2026' },
    { title: 'Best Mobile Security Apps', image: '/images/categories/cat-nordvpn-express.webp', url: '/guides/best-mobile-security-apps-2026' },
    { title: 'Best Password Managers', image: '/images/categories/cat-password-manager.webp', url: '/guides/best-password-managers-2026' },
    { title: 'Identity Theft Protection', image: '/images/categories/cat-privacy-guide.webp', url: '/guides/best-identity-theft-protection-services-2026' },
  ];
