    ...
    <footer className="bg-navy-950 text-white mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-7 h-7 rounded-md bg-trust-green flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-white"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="m9 12 2 2 4-4"/></svg>
              </div>
              <span className="font-display font-bold text-white">SecureChoiceGuide</span>
            </div>
            <p className="text-sm text-navy-300 leading-relaxed">Independent security reviews and privacy guides you can trust.</p>
            <a href="mailto:contact@securechoiceguide.com" className="inline-block mt-3 text-sm text-navy-400 hover:text-trust-green transition-colors">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <div className="flex items-center gap-2 px-4 py-2 border border-navy-700 rounded-lg text-xs font-display font-medium text-navy-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-trust-green"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg>
            Independently Tested
          </div>
          <div className="flex items-center gap-2 px-4 py-2 border border-navy-700 rounded-lg text-xs font-display font-medium text-navy-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-trust-green"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>
            No Affiliate Bias
          </div>
          <div className="flex items-center gap-2 px-4 py-2 border border-navy-700 rounded-lg text-xs font-display font-medium text-navy-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-trust-green"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            Updated Weekly
          </div>
        </div>

        {/* Affiliate Disclosure */}
        <div className="mt-8 p-4 border border-navy-700 rounded-lg bg-navy-900">
